...
[-1, 2, 3].none(isLessThanZero) => false [-1, -2, -3].none(isGreaterThanZero) => true
any
...
Do not use any pre-written methods, write from scratch. (.every(), .some(), .reduce(), etc. are disallowed)
*/
