...
This means that the seating plan changes every month. Both staff members' names and the number of rows of seats may change.
...
const binRota = arr => arr.map((row, idx) => idx % 2 ? row.reverse() : row).flat()