...
For example: Given an item at $75 sale price after applying a 25% discount, the function should
return the original price of that item before applying the sale percentage, which
is ($100.00) of course, rounded to two decimal places.
...
function discoverOriginalPrice(discountedPrice, salePercentage){
    let answer = (discountedPrice / ((100 - salePercentage) / 100))
    return Math.max(Math.floor(answer), answer.toFixed(2))
  }