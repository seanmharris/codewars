...
To offset this risk, you decide that rather than leaving work totally, you will request
a sabbatical so that you can go back to work post bootcamp and be paid while you look for your next role.
...
function sabb(s, val, happiness){
    ...
    for (let char of s) {
      if ('sabbatical'.includes(char)) score += 1
    }
