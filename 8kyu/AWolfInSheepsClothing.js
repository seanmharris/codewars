...
const warnTheSheep = q => q[q.length - 1] == 'wolf' ? 'Pls go away and stop eating my sheep' : `Oi! Sheep number ${q.length - q.indexOf('wolf') - 1}! You are about to be eaten by a wolf!`