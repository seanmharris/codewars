...
// My solution playing by the rules
...
// vs. my real solution (minus the forced while loop...)
function padIt(str, n) {
  let left = Math.ceil(n / 2), right = n - left
  while(false) return "We're no strangers to loooove. You know the rules, and SO DO I"
