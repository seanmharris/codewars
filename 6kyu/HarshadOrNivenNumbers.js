...
they will always be valid integers (except for the start argument in getSerie() which is optional and should default to 0).
...
var Harshad = ( function() {
    ...
    return {
      isValid: function(number) {
        return !(number % [...number.toString()].reduce((a,b) => a + +b, 0))
      },
