...
You have to combine all digits left and right, perhaps with "." inside (doubles), and to calculate the result which has to be
...
const calculateString = st => Math.round(eval(st.replace(/[^0-9+-/*]/g, ''))).toString()